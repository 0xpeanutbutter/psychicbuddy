...
if 1 == 1 :
    print(os.listdir('.'))  # change 
    print(os.listdir('Yolo'))
    # print(os.listdir('../input/objectdetection')) # change path for your own dataset

    # change image names
    img_names = ['Yolo/dog.jpg','Yolo/office.jpg']
...
if __name__ == '__main__':
    ...
    assign_ops = load_weights(model_vars, 'Yolo/yolov3.weights')
